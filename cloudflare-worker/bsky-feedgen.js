...
function verifySearchTermMatch(text) {
  const regex = /(#rhobh|#rhony|#rhoa|#rhoslc|#rhoc|#rhop|#rhonj|#realhousewives|#bravo|(?:real housewives)|(?:real housewives of)|(?:Andy cohen)|(?:bergie)|(?:love island usa)|(?:love island games))/i;
